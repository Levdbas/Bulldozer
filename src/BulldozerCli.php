...
/**
 * WP-CLI commands for Bulldozer.
 */

namespace HighGround\Bulldozer;

/**
 * WP-CLI commands for managing Bulldozer functionality.
 */
class BulldozerCli
{
   /**
   ...
   public static function register()
   {
      ...
      \WP_CLI::add_command('bulldozer clear-manifest-cache', [__CLASS__, 'clear_manifest_cache']);
   }
    ...
    *
    * Use this command after changing favicon files or manifest attributes to force
    * Bulldozer to write a fresh manifest to disk.
    *
    * ## EXAMPLES
    *
    ...
    * @when after_wp_load
    */
   public function clear_manifest_cache($args, $assoc_args)
   {
      Site_Icons::clear_manifest_cache();

      \WP_CLI::success('Site icons manifest cache cleared successfully.');
   }
